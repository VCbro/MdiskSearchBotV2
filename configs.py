...
class Config(object):
    API_ID = int(os.getenv("API_ID", "12139762"))
    API_HASH = os.getenv("API_HASH", "c03b4f089a7d7a30b728e5b473a73316")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001848776738")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Vyasviraj123:Vyasviraj123@cluster0.hapnior.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001645272264"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "cvmoviesnew")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "Q1F6s9tHgK935F4M2IFv")
